#https://github.com/jetson-tx2/NVIDIA-TensorRT-Tutorial/blob/master/model1.py

import tensorflow as tf
import numpy as np

with tf.Session() as sess:
    with tf.gfile.GFile('./artifacts/model1.pb', 'rb') as f:
        ...
        warmup_sample = np.expand_dims(np.uint8(np.random.randint(low=0, high=255, size=(128, 128, 3))), axis=0)
